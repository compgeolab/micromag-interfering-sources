...
\textcolor{red}{Say something about applications where getting NRM direction like this could be advantageous, for example doing some kind of microscale fold or conglomerate test. I think this should be an important conclusion to highlight}
