...
\noindent{These normalization procedures ensure that each parameter falls within a unitary range for a given M number of the simplex optimization iterations, $j = 1,2,..., M$.}
