...
\subsubsection{Signal removal} 
    ...
    \begin{enumerate}
        ...
        \item \textbf{No visible advantage over windowed data}: Tests with synthetic data (see supplementary files) showed no significant advantage over windowed data. In fact, the latter performed significantly better in the benchmark.
