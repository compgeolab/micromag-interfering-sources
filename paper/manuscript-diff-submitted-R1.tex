...
%DIF DEL /tmp/s6bZsycj6R/latexdiff-vc-submitted-R1/manuscript.tex   Thu Nov 13 09:42:47 2025
%DIF ADD manuscript.tex                                             Fri Feb 27 13:55:18 2026
%
...
\newcommand{\KeyPoints}{%
\begin{itemize}
    \item Magnetic microscopy enables high spatial resolution and sensitivity at the microscale, allowing for more detailed paleomagnetic studies.
    \item Nonlinear inversion and iterative dipole removal yield better directions and increased source recovery.
    \item The proposed method detects weaker sources in synthetic data and achieves a 3° misfit in NRM retrieval for real basaltic samples.
\end{itemize}
}
